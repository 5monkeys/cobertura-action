...
test("action", async () => {
  ...
  process.env["INPUT_SHOW_MISSING_FRACTION"] = "false";
...
test("action with missing lines fraction", async () => {
  const { action } = require("./action");
  process.env["INPUT_PATH"] = "./src/fixtures/test-branch.xml";
  process.env["INPUT_SKIP_COVERED"] = "true";
  process.env["INPUT_SHOW_BRANCH"] = "false";
  ...
  process.env["INPUT_SHOW_CLASS_NAMES"] = "false";
  process.env["INPUT_SHOW_MISSING"] = "false";
  process.env["INPUT_SHOW_MISSING_FRACTION"] = "true";
  process.env["INPUT_SHOW_MISSING_MAX_LENGTH"] = "5";
  process.env["INPUT_ONLY_CHANGED_FILES"] = "false";
  process.env["INPUT_PULL_REQUEST_NUMBER"] = "";
  const prNumber = 1;
  nock("https://api.github.com")
...
| File | Coverage | Branches | > Threshold |
| - | :-: | :-: | :-: |
...
| File | Coverage | Lines | Branches | > Threshold |
| - | :-: | :-: | :-: | :-: |
...
| File | Coverage | Lines | Branches | > Threshold | Missing |
| - | :-: | :-: | :-: | :-: | :-: |
| **All files** | \`77%\` | \`77%\` | \`0%\` | :white_check_mark: |   |
...
<p align="right">Generated by :monkey: cobertura-action against deadbeef </p>`);
  ...
  expect(
    markdownReport([dummyReport], commit, {
      ...
      showBranch: true,
      showMissing: false,
      showMissingFraction: true,
      showMissingMaxLength: 5,
    })
  ).toBe(`<strong>${defaultReportName}</strong>

| File | Coverage | Lines | Branches | > Threshold | Missing (:heavy_division_sign:) |
| - | :-: | :-: | :-: | :-: | :-: |
| **All files** | \`77%\` | \`77%\` | \`0%\` | :white_check_mark: |   |
| \\_\\_init\\_\\_.py | \`80%\` | \`80%\` | \`0%\` | :white_check_mark: | \`4/5\` |
| bar.py | \`75%\` | \`80%\` | \`0%\` | :white_check_mark: | \`4/5\` |
| foo.py | \`75%\` | \`100%\` | \`75%\` | :white_check_mark: |   |
