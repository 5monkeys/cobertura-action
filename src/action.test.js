...
test("markdownReport", () => {
  ...
  expect(markdownReport(dummyReport, commit, { minimumCoverage: 70, reportName: reportName }))
...
<p align="right">Generated by :monkey: cobertura-action against deadbeef </p>`);
  ...
  expect(markdownReport(dummyReport, commit)).toBe(`<strong>${defaultReportName}</strong>
...
<p align="right">Generated by :monkey: cobertura-action against deadbeef </p>`;
  ...
  nock("https://api.github.com")
      ...
      .reply(200)
      .get(`/repos/${owner}/${repo}/issues/${prNumber}/comments`)
      .reply(200, [{ body: report1Comment, id: comment1Id }, { body: report2Comment, id: comment2Id }])
